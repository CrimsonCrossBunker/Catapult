...
const _PR_URL = {
	...
	"ccb": "https://api.github.com/search/issues?q=repo%3ACrimsonCrossBunker/Cataclysm-Cleanwater-Bomb",
}
...
const _COMMITS_URL = {
	...
	"ccb": "https://api.github.com/repos/CrimsonCrossBunker/Cataclysm-Cleanwater-Bomb/commits",
}
